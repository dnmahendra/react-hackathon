...
var RCFilters = React.createClass({
  filterClickedCallback : function(filter_name) {
    if (this.isSelected(filter_name)) {
      var index = this.state.selectedFilters.indexOf(filter_name);
      this.setState({
        selectedFilters: this.state.selectedFilters.slice(0, index).concat(this.state.selectedFilters.slice(index+1, this.state.selectedFilters.count))
      });
    } else {
      this.setState({
        selectedFilters: this.state.selectedFilters.concat([filter_name])
      });
    }
  },
  ...
  getInitialState: function(){
    return {selectedFilters: ["overseas-spending"]};
  },
  render: function() {
    return (
      <aside className='col-md-3 facets sidebar-offcanvas'>
        ...
        <div className='panel panel-default' id='facet-bucket'>
          ...
          <div className='list-group'>
            <RCFilter count={this.props.filters.bucket_low_rates.doc_count} id="low-rates" name="Low Rates" onClick={this.filterClickedCallback} selected={ this.isSelected("low-rates") } />
            <RCFilter count={this.props.filters.bucket_low_fees.doc_count} id="low-fees" name="Low Fees" onClick={this.filterClickedCallback} selected={ this.isSelected("low-fees") } />
            ...
            <RCFilter count={this.props.filters.bucket_frequent_flyer.doc_count} id="frequent-flyer" name="Frequent Flyer Rewards" onClick={this.filterClickedCallback} selected={ this.isSelected("frequent-flyer") } />
            <RCFilter count={this.props.filters.bucket_overseas_spending.doc_count} id="overseas-spending" name="Overseas Spending" selected={true} onClick={this.filterClickedCallback} selected={ this.isSelected("overseas-spending") } />
        ...
        <div className='panel panel-default'>
          ...
          <div className='list-group'>
            <RCFilter count={this.props.filters.bucket_intro_offers.doc_count} id="intro-offers" name="Introductory Offers" onClick={this.filterClickedCallback} selected={ this.isSelected("intro-offers") } />
            <RCFilter count={this.props.filters.bucket_bt_intro_offers.doc_count} id="bt-offers" name="Balance Transfer Offers" onClick={this.filterClickedCallback} selected={ this.isSelected("bt-offers") } />
            <RCFilter count={this.props.filters.bucket_special_offers.doc_count} id="special-offers" name="Special Offers" onClick={this.filterClickedCallback} selected={ this.isSelected("special-offers") } />
            <RCFilter count={this.props.filters.bucket_all_offers.doc_count} id="all-offers" name="All Offers" onClick={this.filterClickedCallback} selected={ this.isSelected("all-offers") } />
          </div>
        </div>
        <div className='panel panel-default'>
          <div className='panel-heading'>
          ...
          <div className='list-group'>
            <RCFilter count={this.props.filters.bucket_big_four.doc_count} id="big-banks" name="Big 4 Banks" onClick={this.filterClickedCallback} selected={ this.isSelected("big-banks") } />
